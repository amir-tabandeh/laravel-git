...
(function() {
  ...
  (function($) {
    ...
    Slider.prototype = {
      ...
      resize: function() {
        return this.$rel.css('left', this.calculateScroll(this.current));
      },
      jump: function(slide, transitionTime, noanimation) {
        ...
        if (this.$slides.length >= slide && !this.slideChangeInProgress) {
          ...
          if (this.options.parallax) {
            ...
            this.moveStartScroll = parseInt(this.$rel.css('left'), 10);
            step = function() {
              var position;
              position = Math.round(r.currentBgPosition - (r.moveStartScroll - parseInt(r.$rel.css('left'), 10)) * r.options.parallaxDistance * r.options.parallaxDirection) + 'px 0';
          ...
          this.$rel.animate({
            'left': this.calculateScroll(slide)
          }, animateOptions);
        }
        return null;
      },
      set: function(slide, init) {
        ...
        gWidth = this.getGlobalWidth();
        this.$rel.css('left', this.calculateScroll(slide));
        this.current = slide;
        this.slide = slide - 1;
        this.updateControls();
        return null;
      ...
      move: function(e) {
        ...
        return this.$rel.css('left', this.moveStartScroll - e.distX);
      },
      moveend: function(e) {
